...
const Work =({image,title , description,date, textmode}:work) => {
    return (
        <div className=' flex  justify-evenly max-[423px]:flex-col  m-4 '>
     ...
     <div className=' w-10/12 '>
        ...
        <p className=' flex justify-between max-[693px]:flex-col  text-gray-500'> <span> {description}  </span> <span> {date} </span> </p>
     </div>
